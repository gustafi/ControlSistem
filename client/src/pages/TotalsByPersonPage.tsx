 ...
 * Lista pessoas com total de receitas, despesas e saldo (receita - despesa).
 * Exibe o total geral ao final. Suporta paginação.
 */
import { useState, useEffect } from 'react'
import { reportsApi } from '../api'
import type { TotalByPersonItem } from '../types'
...
export default function TotalsByPersonPage() {
  const [items, setItems] = useState<TotalByPersonItem[]>([])
  ...
  useEffect(() => {
    reportsApi.getTotalsByPerson(page, pageSize)
      .then(res => {
        setItems(res.items)
  ...
  return (
    <div>
      ...
      <p className="text-muted">Receitas, despesas e saldo de cada pessoa cadastrada, com total geral ao final.</p>
